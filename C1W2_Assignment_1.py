...
# <a name='ex-1'></a>
# ### Exercise 1 (ungraded)
# Set test to `"Hello World"` in the cell below and run the next two cells.
...
def softmax(x):
    ...
    s = x_exp/x_sum.reshape(x_sum.shape[0],1)
